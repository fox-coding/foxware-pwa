...
<div class="hidden xl:flex items-center justify-end">
  <div class="hidden xl:flex items-center justify-end mr-12">
      ...
      >
        ...
        <span v-if="wishlistCount > 0" class="inline-block w-auto px-2 h-auto text-center bg-white rounded-full font-semibold font-heading text-dark">{{ wishlistCount }}</span>
      </SwButton>
      <SwButton
      ...
      >
        ...
        <span v-if="count > 0" class="inline-block w-auto px-2 h-auto text-center bg-white rounded-full font-semibold font-heading text-dark">{{ count }}</span>
      </SwButton>
